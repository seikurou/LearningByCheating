...
REPO=BEVSEG/LearningByCheating
...
mkdir -p $DATA/BEVSEG/LearningByCheating/data
ln -s $DATA/BEVSEG/LearningByCheating/data $CODE/BEVSEG/LearningByCheating/data
mkdir -p $DATA/BEVSEG/LearningByCheating/simulator
ln -s $DATA/BEVSEG/LearningByCheating/simulator $CODE/BEVSEG/LearningByCheating/simulator
